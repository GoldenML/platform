...
<%--<br/>--%>
        ...
        <div class="col-lg-6 col-lg-md-5     col-lg-offset-1" id="div_con">
            ...
            <div class="col-lg-offset-2 col-lg-md-5">
                <form>
                    <div>
                         <input name="nickname" id="sname" class="form-control" placeholder="姓名" style="height:60px;"/>
                    </div>
                    <br />
                    <div>
                        <input name="phone" id="sphone" class="form-control" placeholder="手机号" style="height:60px;"/>
                    </div>
                    <br />
                    <div>
                        <input type="password" id="passwd" name="passwd" class="form-control" placeholder="密码" style="height:60px;"/>  </td>
                    </div>
                    <br />

                    <div>
                        <input autocomplete="off" type="password" id="repeat_passwd" name="repeat_passwd" class="form-control" placeholder="重复密码" style="height:60px;"  onkeyup="validate()" /> <br/><span id="tishi"></span>
                    </div>
                    <br />
