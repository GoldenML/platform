...
/**
 * @author shkstart
 * @create 2019-06-06 19:16
 */
@ServerEndpoint("/webSocket/chat/{roomName}/{ssname}")
public class WsServer {
    ...
    @OnMessage
    public void receiveMsg(@PathParam("ssname") String name,@PathParam("roomName") String roomName,
